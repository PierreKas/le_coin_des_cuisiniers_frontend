...
import 'package:le_coin_des_cuisiniers_app/controller/product_restock_history_controller.dart';
...
class _ProductRestockHistoryState extends State<ProductRestockHistory> {
  ...
  Future<List<ProductRestockHistoryModel>> getHistory(String prCode) async {
    _productRestockHistory = await ProductRestockHistoryController()
        .getHistoryByCode(prCode, context);
    setState(() {});
                      ...
                      pw.Container(
                        ...
                        child: pw.Column(
                          ...
                          children: [
                            ...
                            _buildRestockDetailRow('Marque',
                                '${record.oldBrand}', '${record.newBrand}'),
                          ],
                        ),
                      ),
                      pw.SizedBox(height: 20),
