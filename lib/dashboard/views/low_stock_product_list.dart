...
class LowStockProductsList extends StatefulWidget {
  const LowStockProductsList({super.key});

  @override
  State<LowStockProductsList> createState() => _LowStockProductsListState();
}

class _LowStockProductsListState extends State<LowStockProductsList> {
  @override
  void initState() {
    super.initState();
    loadAllProducts();
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      const MyTextContent(
                          content: 'Liste des produits à faible stock'),
                      SizedBox(
                        width: 300,
